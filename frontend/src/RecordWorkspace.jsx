    ...
    <div className="record-workspace">
        ...
        <>
          <label className="semester-control">
            ...
            >
              ...
              {[...new Set(subjects.map((s) => s.semester))].sort().map((s) => (
          ...
          <section className="workspace-card">
            ...
            <h3 className="form-title">
              {editing?.type === "subjects" ? "Edit subject" : "Add a subject"}
            </h3>
            <Editor
              key={
          ...
          <section className="workspace-card" id="marks-panel">
            ...
            <p className="subtle">
              Every mark keeps its date and grading scale. Practice results stay
              separate.
            </p>
                  ...
                  <tbody>
                    {shownMarks.map((m) => (
                      <tr key={m.id}>
                        ...
                        <td>{actions("assessments", m, `mark ${m.title}`)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
      ...
      {data && tab === "Projects" && (
        <section className="workspace-card">
          ...
          <p className="subtle">
            Keep the story behind your work: your role, what you built, and what
            you learned.
          </p>
