...
from ..core import accounts, sessions
...
from ..features.github import RepoInput, preview_repo
...
async def personal_chat(
    ...
    from ..ai.orchestrator import chat
    ...
    async with state["lock"]:
        ...
        if body.project_id:
            from ..features.projects import detail
